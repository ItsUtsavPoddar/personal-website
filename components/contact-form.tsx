          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <Input
                ...
                required
                className="bg-zinc-900/50 border-zinc-700 focus:border-neutral-500 focus:ring-purple-500/20"
              />
            </div>
            <div className="space-y-2">
              <Input
            ...
            <Button
              type="submit"
              className="w-full bg-gradient-to-r from-neutral-500 to-neutral-700 hover:from-teal-800 hover:to-neutral-500 border-0"
